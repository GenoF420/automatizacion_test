...
try:
    ...
    assert f"https://www.recorrido.cl/es/bus/santiago/la-serena/{tomorrow_url_format}" in driver.current_url, "La URL de resultados no se cargó correctamente."

    print(f"Test completado exitosamente: Se encontraron resultados de viajes para el día {tomorrow}.")
