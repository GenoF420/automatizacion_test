# prueba 4 Genaro - Login con usuario incorrecto y password correcto
...
try:
    ...
    # And: ingreso como usuario "usuarioFalso@algo.com"
    email_field = driver.find_element(By.XPATH, '//*[@id="user_email"]')
    email_field.clear()
    email_field.send_keys("usuarioFalso@algo.com")
    time.sleep(1)
    ...
    print("Test completado exitosamente: Mensaje de error mostrado y redirección correcta.")
